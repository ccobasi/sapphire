...
const employees = ref([
  { name: 'Codeware Dummy (Testing)', employeeCode: 'jd001', busUnit: 'Global', email: 'johndoe@email.com', mobile: '0801234598', joinDate: '6/19/2023', gender: 'male', birthday: '01/01/1990' },
  { name: 'Jane Smith', employeeCode: 'js002', busUnit: 'Marketing', email: 'janesmith@email.com', mobile: '0802345678', joinDate: '7/10/2023', gender: 'female', birthday: '05/15/1992' },
  { name: 'Mike Johnson', employeeCode: 'mj003', busUnit: 'IT', email: 'mikejohnson@email.com', mobile: '0803456789', joinDate: '8/22/2023', gender: 'male', birthday: '11/22/1985' },
  { name: 'Emily Brown', employeeCode: 'eb004', busUnit: 'HR', email: 'emilybrown@email.com', mobile: '0804567890', joinDate: '9/15/2023', gender: 'female', birthday: '03/03/1988' },
  { name: 'Alex Lee', employeeCode: 'al005', busUnit: 'Finance', email: 'alexlee@email.com', mobile: '0805678901', joinDate: '10/05/2023', gender: 'male', birthday: '07/07/1995' },
]);
...
onMounted(() => {
  store.currentpage = 'upcoming-birthday';
