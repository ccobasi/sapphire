...
const companyUnitOptionModal = ref('')

const tempData = [
    {
        company_unit_name:"RSL",
...
const tempHeadings = ["Company Unit Name","Status","Action"]
...
onMounted(() => {
    store.currentpage = 'company_units';
...
<template>
    <div class="vacancies mt-4">
        <div class="heading">
            <div class="title">
                <h1>Company Units</h1>
                <p>Here is a list of your Company Units</p>
            </div>
            <div class="buttons d-flex">
                <button class="btn btn-primary add-vacancy-button" @click="companyUnitOptionModal='add';showDepartmentModal=true">Add Company Unit</button>
               
            </div>
        </div>

        <div class="row">
            <TableOne :tableData=tempData :headings=tempHeadings :tableType="'company_unit'"  />
        </div>

        <div class="modal" v-show="showDepartmentModal">
            <div class="modal-content">
                <div class="top-section mt-4">
                    <h3 class="title text-capitalize">Add Company Unit</h3>
                ...
                <div class="subsection text-center mt-2">
                    <p v-if="companyUnitOptionModal==='add'">Input the name of unit to get added</p>
                ...
                <div class="main">
                    ...
                    <div class="page flex-column" v-if="companyUnitOptionModal==='add'">
                        
                        <div class="form-group mt-4">
                            <label for="">Company Unit Name</label>
