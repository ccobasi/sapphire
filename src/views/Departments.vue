...
const tempHeadings = ["Department Name","Status","Action"]
    ...
    <div class="vacancies mt-4">
        <div class="heading">
            ...
            <div class="buttons d-flex">
                <button class="btn btn-primary add-vacancy-button" @click="departmentModalOption='add';showDepartmentModal=true">Add Department</button>
                <button class="btn add-vacancy-button" @click="departmentModalOption='import';showDepartmentModal=true">Import Department</button>
            </div>
        </div>
        ...
        <div class="modal" v-show="showDepartmentModal">
            <div class="modal-content">
                <div class="top-section mt-4">
                    <h3 class="title text-capitalize">{{departmentModalOption}} Department</h3>
                ...
                <div class="subsection text-center mt-2">
                    <p v-if="departmentModalOption==='add'">Input the department name to get added</p>
                ...
                <div class="main">
                   ...
                   <div class="save-button">
                        <button class="btn btn-primary" >{{departmentModalOption==='add' ? 'Add' : departmentModalOption === 'import' ? 'upload' : ''}}</button>
                   </div>
                </div>
            </div>
        </div>
