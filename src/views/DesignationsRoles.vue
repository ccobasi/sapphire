...
const tempData = [
    {
        designation:"HEAD, DOMESTIC OPERATIONS",
        role:"HOD",
    },   
    {
        designation:"HEAD, DOMESTIC OPERATIONS",
...
const tempHeadings = ["Designation", "Role", "Action"]
...
onMounted(() => {
    store.currentpage = 'designation_roles';
    ...
    <div class="vacancies mt-4">
        <div class="heading">
            <div class="title">
                ...
                <p>Here are lists of your Designation Roles</p>
            </div>
        ...
        <div class="row">
            <TableOne :tableData=tempData :headings=tempHeadings :tableType="'designation_roles'"  />
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="main">
                   ...
                   <div class="save-button">
                        <button class="btn btn-primary text-capitalize" >{{designationModalOption==='add' ? 'add' : designationModalOption === 'import' ? 'upload' : ''}}</button>
                   </div>
                </div>
            </div>
        </div>
